...
1. You get nervous trying to remember the exact words.
2. Your eyes glaze over as you recite them from memory.
3. If you miss one word, you panic and stop.
4. You sound like a robot.
...
1. **Know your 3 key messages** (not word-for-word, just concepts)
2. **Think of specific examples** for each point
3. **Practice telling the stories out loud** to a colleague (not reading)
4. **Forget the exact words** when the camera starts
